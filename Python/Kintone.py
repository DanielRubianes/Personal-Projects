...
class Kintone_App:
    ...
    def get_records(self, fields: list[str], query: str='', _last_record_id: int = None):
        ...
        if total_count > chunk_size:
            ...
            return records + self.get_bulk_records(fields, query, last_record_id)
        else:
            return records
...
records = test_app.get_bulk_records(['Record_Status', 'Record_number', 'Text_1'], 'Record_Status in ("Need to Order")')
